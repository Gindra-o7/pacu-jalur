        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <p className="text-lg sm:text-xl text-gray-700 leading-relaxed font-body">
              <strong className="text-green-700">Pacu Jalur</strong> adalah festival perahu tradisional unik dari Kuantan Singingi, Riau, 
              yang telah menjadi warisan budaya mendunia. Tradisi ini menampilkan lomba perahu panjang dengan 
            ...
            <p className="text-base sm:text-lg text-gray-600 leading-relaxed font-body">
              Festival ini telah menarik lebih dari <strong className="text-blue-600">50.000 pengunjung</strong> setiap tahunnya 
              dan telah berlangsung selama <strong className="text-brown-600">lebih dari 100 tahun</strong>, 
              menjadikannya salah satu tradisi budaya tertua di Indonesia.
            </p>
          ...
          <div className="relative">
            <div className="aspect-video rounded-2xl overflow-hidden shadow-2xl">
              <img 
                src="/pacu-jalur/pacu-jalur-2.png" 
                alt="Pacu Jalur Festival" 
