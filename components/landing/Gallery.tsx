...
export default function Gallery() {
  const galleryImages = [
    {
      src: getStorageImageUrl("/public/pacu-jalur-3.jpeg"),
      alt: "Lomba Pacu Jalur",
      title: "Lomba Pacu Jalur",
      category: "Festival",
    },
    {
      src: getStorageImageUrl("/public/pacu-jalur-4.jpeg"),
      alt: "Penari Togak Luan",
      title: "Togak Luan",
      category: "Budaya",
    },
    {
      src: getStorageImageUrl("/public/pacu-jalur-5.jpeg"),
      alt: "Pemandangan Sungai",
      title: "Sungai Kuantan",
      category: "Alam",
    },
    {
      src: getStorageImageUrl("/public/pacu-jalur-6.jpeg"),
      alt: "Perahu Tradisional",
      title: "Perahu Tradisional",
      category: "Heritage",
    },
    {
      src: getStorageImageUrl("/public/pacu-jalur-7.jpeg"),
      alt: "Festival Atmosphere",
      title: "Atmosfer Festival",
      category: "Festival",
    },
    {
      src: getStorageImageUrl("/public/pacu-jalur-8.jpeg"),
      alt: "Culinary Delights",
      title: "Kuliner Khas",
      category: "Kuliner",
    },
    {
      src: getStorageImageUrl("/public/pacu-jalur-9.jpeg"),
      alt: "Traditional Crafts",
      title: "Kerajinan Tradisional",
      category: "Kerajinan",
    },
    {
      src: getStorageImageUrl("/public/pacu-jalur-10.jpeg"),
    ...
    <section id="gallery" className="py-20 bg-linear-to-b from-gray-50 to-white">
      <div className="max-w-6xl mx-auto px-4">
          ...
          {galleryImages.map((image, index) => (
            <div key={index} className="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="aspect-square relative">
                <Image src={image.src} alt={image.alt} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" fill placeholder="blur" blurDataURL={BLUR_DATA_URL} />
        ...
        <div className="text-center mt-12">
          <button className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg font-body">Lihat Galeri Lengkap</button>
        </div>
      </div>
    </section>
  );
