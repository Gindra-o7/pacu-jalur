        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-gray-800">
            <Link href="/customer" className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h2 className="font-bold text-lg font-heading">Customer Dashboard</h2>
                {isLoading ? (
          ...
          <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
            {menuItems.map((item) => {
              ...
              const isActive = item.href === "/customer" ? pathname === item.href : pathname === item.href || pathname?.startsWith(item.href + "/");
